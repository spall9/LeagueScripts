...
namespace T2IN1_Wukong
{
    internal static class LaneClear
    {
        ...
        {
            var MinionQ = ObjectManager.Get<Obj_AI_Minion>().FirstOrDefault(mq => mq.IsMinion && mq.IsValidTarget(Q.Range));
            ...
            var MinionW = ObjectManager.Get<Obj_AI_Minion>().FirstOrDefault(mw => mw.IsMinion && mw.IsValidTarget(W.Range = 150));
            ...
            var MinionE = ObjectManager.Get<Obj_AI_Minion>().FirstOrDefault(me => me.IsMinion && me.IsValidTarget(E.Range));
