...
using Mario_s_Lib;
using static RaINAIO.RengarMenus;

namespace RaINAIO
{
    public static class RengarSpellsManager
    {
        /*
        ...
        */
        ...
        public static void InitializeSpells()
        {
            ...
            E = SpellSlot.E.GetSkillShotData(SkillShotType.Linear);
            ...
            switch (slot)
            {
                case SpellSlot.Q:
                    if (Q.IsReady())
                    {
                        ...
                        dmg += new float[] { 100, 105, 110, 115, 120 }[sLevel] + 0.0f * AD;
                    }
                    break;
                case SpellSlot.W:
                    if (W.IsReady())
                    {
                        ...
                        dmg += new float[] { 50, 80, 110, 140, 170 }[sLevel] + 0.80f * AP;
                    }
                    break;
                case SpellSlot.E:
                    if (E.IsReady())
                    {
                        ...
                        dmg += new float[] { 50, 100, 150, 200, 250 }[sLevel] + 0.70f * AD;
                    }
                    break;
                case SpellSlot.R:
                    if (R.IsReady())
                    {
                        ...
                        dmg += new float[] { 0, 0, 0 }[sLevel]+ 0.0f * AD;
                    }
                    break;
            }
