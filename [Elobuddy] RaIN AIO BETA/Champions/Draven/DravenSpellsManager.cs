...
namespace RaINAIO
{
    public static class DravenSpellsManager
    {
        /*
            ...
            switch (slot)
            {
                case SpellSlot.Q:
                    if (Q.IsReady())
                    {
                        ...
                        dmg += new float[] { 45, 55, 65, 75, 85 }[sLevel] + 0.20f * AD;
                    }
                    break;
                case SpellSlot.W:
                    if (W.IsReady())
                    {
                        ...
                        dmg += new float[] { 0, 0, 0, 0, 0 }[sLevel] + 0.20f * AP;
                    }
                    break;
                case SpellSlot.E:
                    if (E.IsReady())
                    {
                        ...
                        dmg += new float[] { 70, 105, 140, 175, 210 }[sLevel] + 0.20f * AD;
                    }
                    break;
                case SpellSlot.R:
                    if (R.IsReady())
                    {
                        ...
                        dmg += new float[] { 175, 275, 375 }[sLevel]+ 0.20f * AD;
                    }
                    break;
            }
