...
namespace RaINAIO
{
    internal class ViktorMenus
    {
        ...
        {
            FirstMenu = MainMenu.AddMenu("RaIN AIO " + Player.Instance.ChampionName, Player.Instance.ChampionName.ToLower() + "Viktor");
            ...
            ComboMenu.CreateCheckBox("Use E", "usecomboE", true);
